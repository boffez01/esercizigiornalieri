...
function sumArrayWithForEach(array) {
  ...
  console.log(sumArrayWithForEach([1, 2, 3, 4]));
...
function sumArrayWithReduce(array) {
  ...
  console.log(sumArrayWithReduce([1, 2, 3, 4]));

/* ESERCIZIO 6 (map)
  Scrivi una funzione che, dato un array di soli numeri e un numero n come parametri, ritorni un secondo array con tutti i valori del precedente incrementati di n
*/
function incrementArrayByN(array, n) {
    return array.map(num => num + n);
  }
  console.log(incrementArrayByN([1, 2, 3], 5));
...
const movies = [
  ...
  */
    function sumYearsOfMovies(movies) {
        return movies.reduce((sum, movie) => sum + parseInt(movie.Year), 0);
      }
      console.log(sumYearsOfMovies(movies));
  ...
  */
    function findMovieByImdbID(movies, imdbID) {
      ...
      console.log(findMovieByImdbID(movies, "tt0167260"));
  
  /* ESERCIZIO 15 (findIndex)
    Scrivi una funzione per ottenere dall'array fornito l'indice del primo film uscito nell'anno fornito come parametro.
  */
    function findIndexOfFirstMovieByYear(movies, year) {
        return movies.findIndex(movie => movie.Year === year.toString());
      }
      console.log(findIndexOfFirstMovieByYear(movies, 2005));