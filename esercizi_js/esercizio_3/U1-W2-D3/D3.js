...
// Modifica la massa per vedere risultati diversi
starWarsCharacters[0].mass = 300; // Cambia la massa di Luke, ad esempio
...
console.log("Initial Length of charactersNames:", charactersNames.length);

for (let i = 0; i < femaleCharacters.length; i++) {
  charactersNames = charactersNames.filter(name => name !== femaleCharacters[i].name);
}

console.log("Final Length of charactersNames:", charactersNames.length);

/* --EXTRA-- ESERCIZIO 10
  Crea una funzionalità che selezioni un elemento casuale dall'array "starWarsCharacters" e ne stampi in console le proprietà in modo discorsivo (a tuo piacimento).
*/
function randomCharacterInfo() {
